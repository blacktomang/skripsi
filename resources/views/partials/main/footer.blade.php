        ...
        <div class="col-lg-4 col-md-6 col-12">
          <div class="single-footer f-contact">
            ...
            <ul>
              ...
              <li>Alamat : <span id="footer-alamat"></span> <br>
                Telpon : <span id="footer-telp"></span><br>
                Whatsapp : <a id="footer-wa" href="https://wa.me/"> </a><br>
                Email : <a id="footer-email" href="mailto:"></a>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div class="col-lg-4 col-md-6 col-12">
          <div class="single-footer f-link">
            ...
            <ul>
              ...
              <li><a href="javascript:void(0)">Daftar Reseller</a></li>
            </ul>
          </div>
        </div>
      </div>
